...
import { addRuntimePromiseToEvent, addRuntimeToData, DataWithRuntime, EventWithRuntimePromise, getRuntimePromiseFromEvent } from '../shared/utils.js'
...
const initRuntime = async <Load extends Kit.Load<any, any, any, any, any>>(
	...
	let resolveRuntimePromise: (runtime: SvelteKitClientRuntime) => void = undefined as unknown as (runtime: SvelteKitClientRuntime) => void
...
export const initRootLayoutLoadWrapper = <LayoutLoad extends Kit.Load<any, any, any, any, any>>(options: {
	initDetectors?: (event: Parameters<LayoutLoad>[0]) => Detector[],
}) => ({
	wrap: <Data extends Record<string, any> | void>(load: (
...
export const initRootPageLoadWrapper = <PageLoad extends Kit.Load<any, any, any, any, any>>(options: {
	browser: boolean
