...
const createLintedMessage = (
  id: string,
  lint: LintReport[] | undefined,
  pattern: LintedPattern
) =>
  ({
    type: "Message",
...
describe("hasLintReports", async () => {
  ...
  test("should throw an error if node type does not get handled", async () => {
    expect(() =>
      hasLintReports({ type: "unknown" } as unknown as LintableNode)
    ).toThrow();
  });
});
...
describe("hasLintErrors", async () => {
  ...
  test("should throw an error if node type does not get handled", async () => {
    expect(() =>
      hasLintErrors({ type: "unknown" } as unknown as LintableNode)
    ).toThrow();
  });
});
...
describe("hasLintWarnings", async () => {
  ...
  test("should throw an error if node type does not get handled", async () => {
    expect(() =>
      hasLintWarnings({ type: "unknown" } as unknown as LintableNode)
    ).toThrow();
  });
});
