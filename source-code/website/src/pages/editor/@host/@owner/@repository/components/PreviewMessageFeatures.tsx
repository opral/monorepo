...
export function PreviewMessageFeatures() {
	const messages = {
		en: mockMessage("What can inlang provide to make localization for developers easier?"),
		de: mockMessage("Was kann inlang bieten, um die Lokalisierung für Entwickler zu erleichtern?"),
		...
		<div class="border border-outline p-4 rounded grid grid-flow-row md:grid-flow-col gap-10 opacity-60">
			<div class="flex flex-col grow gap-4">
				...
				<a
					...
					target="_blank"
				>
					This is a comment of a Message and a preview of future features of the inlang editor.
					Clicking on the elements in this Message will forward you to the corresponding discussion.
				</a>
