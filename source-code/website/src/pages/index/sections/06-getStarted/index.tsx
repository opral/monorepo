						...
						<a href={data.button.href}>
							<button class="relative bg-surface-800">
								...
								<div
									...
									class="absolute z-0 bg-on-background top-0 left-0 w-full h-full opacity-70 blur-3xl"
								/>
								<div
									style={{
										background:
									...
									class="absolute z-0 bg-on-background top-0 left-0 w-full h-full opacity-30 blur-xl"
								/>
								<div
									style={{
										background:
									...
									class="absolute z-0 bg-on-background top-0 left-0 w-full h-full opacity-50 blur-sm"
								/>
							</button>
						</a>
