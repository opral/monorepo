...
const nl: Translation = {
	...
	'random_prefix_enter_name': 'voer uw naam in',
	'random_prefix_find_project_id': 'U kunt het projectId vinden in de instellingen van uw project.',
	'random_prefix_interpolated_string': 'Mijn naam is {name} en mijn favoriete kleur is {color}.',
	'random_prefix_invite_collaborators': '3. Nodig uit en werk samen aan uw vertalingen in het dashboard',
	...
	'random_prefix_linting_errors': 'Je zult pluisfouten krijgen nu de sleutels niet bestaan. Je moet ze nu handmatig toevoegen.',
	'random_prefix_localized_by_us': '1. Deze kaart is al machinaal door ons vertaald',
	'random_prefix_newsletter': 'Wil je geïnformeerd worden wanneer inlang bestaande sleutels en projecten kan importeren?',
}
