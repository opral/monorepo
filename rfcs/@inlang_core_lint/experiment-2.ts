...
type NodeName = "Identifier" | "Resource" | "Message" | "Pattern" | "Text" | "LanguageTag"
...
type Identifier<Extension extends ExtensionInformation = Record<string, unknown>> = Node<
	"Identifier",
	Extension
> & {
	name: string
...
type Resource<Extension extends ExtensionInformation = Record<string, unknown>> = Node<
	"Resource",
	Extension
> & {
...
type Message<Extension extends ExtensionInformation = Record<string, unknown>> = Node<
	"Message",
	Extension
> & {
...
type Pattern<Extension extends ExtensionInformation = Record<string, unknown>> = Node<
	"Pattern",
	Extension
> & {
...
type Text<Extension extends ExtensionInformation = Record<string, unknown>> = Node<
	"Text",
	Extension
> & {
	value: string
...
type LanguageTag<Extension extends ExtensionInformation = Record<string, unknown>> = Node<
	"LanguageTag",
	Extension
> & {
	name: string
