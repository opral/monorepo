...
Supporting features like file-based auth will require a custom git server. Translators are not supposed to have access to the entire source code if they only use a few resource (translation) files. Discussion is ongoing in [https://github.com/inlang/monorepo/discussions/153](https:github.com/inlang/monorepo/discussions/153).
...
A plugin system could enable storing files like SQLite, Jupyter Notebooks, or binary files natively in git. If an SQLite file could be stored in git, inlang and other apps might not require dedicated servers to host data. See [https://github.com/inlang/monorepo/discussions/355](https:github.com/inlang/monorepo/discussions/355).
