...
const lint11 = <R extends Resource1>(resource: R): R<LintResult> => resource as any
...
const lint2 = <R extends Resource2>(resource: R): WithLints<R> => resource as any

const cache2 = <R extends Resource2>(resource: R): WithCache<R> => resource as any
...
const lint3 = <R extends Resource2>(resource: R): R & { lint?: LintInformation } => resource as any

const cache3 = <R extends Resource2>(resource: R): R & { cache: Cache } => resource as any
