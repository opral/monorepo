...
The Paraglide-Solidstart pacakge does a few very usefull things. It automatically sets the language tag for the current request. It also provides internationalized routing, so that you can navigate to translated versions of your pages.
