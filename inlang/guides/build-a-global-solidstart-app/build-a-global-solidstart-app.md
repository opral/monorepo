...
The Adapter does a few very usefull things. It automatically sets the [language tag](https://inlang.com/m/8y8sxj09/library-inlang-languageTag) for the current request. It also provides internationalized routing, so that you can navigate to translated versions of your pages.
