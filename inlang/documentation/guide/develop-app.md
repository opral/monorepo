...
Open a repository locally or with [lix](https://github.com/inlang/inlang/blob/main/lix/design-principles.md). Using lix enables you to use git-based features directly in the browser.
