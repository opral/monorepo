...
A message lint rule validates a message. For example, the [missing translation lint rule](https://inlang.com/m/4cxm3eqi/messageLintRule-inlang-missingTranslation) validates that a message has a translation for a specified [language tag](/documentation/concept/language-tag).
