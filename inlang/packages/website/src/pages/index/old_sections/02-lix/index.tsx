				...
				<div class="w-full flex pt-4 md:pt-20 flex-col xl:flex-row">
					...
					<div class="w-full xl:w-1/2 flex flex-col gap-8 px-6 md:px-4 xl:pt-16 pt-4 pb-16">
						<p class="text-surface-300 text-xl max-w-md">
							Inlang's change control system lix provides full control over
							changes.
						</p>
						...
						image={
							<>
								...
								<div
									...
									style={{
										background:
											"linear-gradient(0deg, #283548 10%, rgba(51, 65, 85, 0.00) 100%)",
									}}
								/>
							</>
						}
						...
						image={
							<>
								...
								<div
									...
									style={{
										background:
											"linear-gradient(-90deg, #283548 10%, rgba(51, 65, 85, 0.00) 100%)",
									}}
								/>
							</>
						}
	...
	return (
		...
		>
			...
			<div class="w-fit h-fit">
				<p class="w-fit text-2xl font-semibold text-left text-background pb-2">
					{props.title}
				</p>
...
export const IconCheck = () => {
	return (
		...
		>
			<path
				d="M9.67094 13.188L7.30594 10.823C7.10427 10.6213 6.8476 10.5205 6.53594 10.5205C6.22427 10.5205 5.9676 10.6213 5.76594 10.823C5.56427 11.0247 5.46344 11.2813 5.46344 11.593C5.46344 11.9047 5.56427 12.1613 5.76594 12.363L8.90094 15.498C9.12094 15.718 9.3776 15.828 9.67094 15.828C9.96427 15.828 10.2209 15.718 10.4409 15.498L16.6559 9.28301C16.8576 9.08134 16.9584 8.82467 16.9584 8.51301C16.9584 8.20134 16.8576 7.94467 16.6559 7.74301C16.4543 7.54134 16.1976 7.44051 15.8859 7.44051C15.5743 7.44051 15.3176 7.54134 15.1159 7.74301L9.67094 13.188ZM11.2109 22.208C9.68927 22.208 8.25927 21.9191 6.92094 21.3412C5.5826 20.7633 4.41844 19.9798 3.42844 18.9905C2.43844 18.0005 1.65487 16.8363 1.07774 15.498C0.500604 14.1597 0.211671 12.7297 0.210938 11.208C0.210938 9.68634 0.499871 8.25634 1.07774 6.91801C1.6556 5.57967 2.43917 4.41551 3.42844 3.42551C4.41844 2.43551 5.5826 1.65194 6.92094 1.07481C8.25927 0.497675 9.68927 0.208741 11.2109 0.208008C12.7326 0.208008 14.1626 0.496941 15.5009 1.07481C16.8393 1.65267 18.0034 2.43624 18.9934 3.42551C19.9834 4.41551 20.7674 5.57967 21.3452 6.91801C21.9231 8.25634 22.2117 9.68634 22.2109 11.208C22.2109 12.7297 21.922 14.1597 21.3441 15.498C20.7663 16.8363 19.9827 18.0005 18.9934 18.9905C18.0034 19.9805 16.8393 20.7644 15.5009 21.3423C14.1626 21.9202 12.7326 22.2087 11.2109 22.208ZM11.2109 20.008C13.6676 20.008 15.7484 19.1555 17.4534 17.4505C19.1584 15.7455 20.0109 13.6647 20.0109 11.208C20.0109 8.75134 19.1584 6.67051 17.4534 4.96551C15.7484 3.26051 13.6676 2.40801 11.2109 2.40801C8.75427 2.40801 6.67344 3.26051 4.96844 4.96551C3.26344 6.67051 2.41094 8.75134 2.41094 11.208C2.41094 13.6647 3.26344 15.7455 4.96844 17.4505C6.67344 19.1555 8.75427 20.008 11.2109 20.008Z"
				fill="#DBDCDF"
			/>
		</svg>
	);
