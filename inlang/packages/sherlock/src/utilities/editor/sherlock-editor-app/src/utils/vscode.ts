...
class VSCodeAPIWrapper {
	...
	/**
	 * Listen for messages sent from the extension (in VS Code) or
	 * from window.postMessage(...) when in a web browser environment.
	 *
	 * @param callback A function that handles the received message.
	 */
