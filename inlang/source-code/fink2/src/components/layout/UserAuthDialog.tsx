...
import { SlInput, SlButton, SlDialog } from "@shoelace-style/shoelace/dist/react";
	...
	return (
		...
		>
			...
			<p className="text-sm leading-[1.5]! max-w-[400px] pb-4 text-zinc-500">
				Your author name is appended to your changes and is visible in the project
				history.
			</p>
			<img src="/setAuthor.png" alt="set author image" className="rounded-lg pb-8" />
			<SlInput
				autoFocus
				label="Username"
