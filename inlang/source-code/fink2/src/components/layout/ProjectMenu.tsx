...
const ProjectMenu = () => {
	...
	const [importPlugin, setImportPlugin] = useState<supportedPluginKeyType | undefined>(
		undefined
	);
	...
	return (
		<div className="flex items-center gap-1">
			...
			<SlDropdown distance={4}>
				...
				<SlMenu>
					<SlMenuItem value="new" onClick={() => setShowNewProjectDialog(true)}>
						New project
					</SlMenuItem>
					<SlMenuItem
						value="open"
						onClick={() => handleOpenProject(setSelectedProjectPath)}
					>
						Open project
					</SlMenuItem>
					...
					<SlMenuItem
						value="merge"
						onClick={() =>
							handleMerge(project, selectedProjectPath, setForceReloadProject)
						}
					>
						Merge file
					</SlMenuItem>
					...
					<SlMenuItem>
						...
						<SlMenu slot="submenu">
							<SlMenuItem
								value="export JSON"
								onClick={() => exportFiles(project, "plugin.inlang.i18next", ".json")}
							>
								JSON
								<SlBadge pill variant="neutral" className="ml-2">
									i18next
							...
							<SlMenuItem
								value="export message format"
								onClick={() =>
									exportFiles(project, "plugin.inlang.messageFormat", ".json")
								}
							>
								Message format
							</SlMenuItem>
