...
const LintRulesHeader = () => {
	return (
		<>
			<div class="relative bg-surface-100 overflow-hidden rounded-xl border border-surface-200 flex flex-col md:flex-row text-center md:text-start items-center py-4 px-6 mb-8 gap-4">
				<div class="w-10 h-10">
					<GuideIcon />
				</div>
				<div class="relative z-30 flex-1 flex flex-col items-center md:items-start gap-1">
					<h2 class="font-medium text-md">{m.marketplace_header_lintRule_toast_title()}</h2>
...
export default LintRulesHeader

function GuideIcon() {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="100%" fill="none" viewBox="0 0 256 256">
			<path
				fill="#000"
