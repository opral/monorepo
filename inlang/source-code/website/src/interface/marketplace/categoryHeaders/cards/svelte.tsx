		...
		<>
			<div class="relative bg-surface-100 overflow-hidden rounded-xl border border-surface-200 flex flex-col md:flex-row flex-wrap md:items-end mb-8 px-4 py-4 gap-4">
				...
				>
					...
					<div class="absolute w-full h-full top-0 bg-gradient-to-r from-[#FF8F8F] to-[#FF906C] rounded-xl z-10 opacity-40" />
				...
				<div class="flex-1 h-[260px] flex flex-col gap-4 md:min-w-[380px]">
					...
					<a
						href="https://github.com/inlang/monorepo/tree/main/inlang/source-code/paraglide/paraglide-js-adapter-vite"
						target="_blanc"
