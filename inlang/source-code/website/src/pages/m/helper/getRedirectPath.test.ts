...
test("getRedirectPath should return the correct path", () => {
	...
	expect(getRedirectPath("/documentation/usage", "/documentation/usage", "/example/usage")).toBe(
		"/example/usage"
	)
	expect(getRedirectPath("/documentation/usage", "/documentation/*", "/example/*")).toBe(
		"/example/usage"
	)
	expect(getRedirectPath("/documentation/usage", "/documentation/*", "/example")).toBe("/example")
