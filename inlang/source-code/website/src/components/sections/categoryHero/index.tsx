	...
	return (
		<>
			<SectionLayout showLines={false} type="white">
				<div class="relative">
					<div class="grid xl:grid-cols-3 xl:gap-8 md:pt-20 pt-16 grid-flow-row-dense min-h-[198px]">
						<div class="relative col-span-2 z-20 xl:mt-0 xl:pb-0">
							<h1 class="xl:col-span-2 text-[40px] md:text-4xl font-bold text-left  leading-none md:leading-tight mb-2">
