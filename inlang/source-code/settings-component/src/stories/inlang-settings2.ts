...
@customElement("inlang-settings2")
export default class InlangSettings2 extends LitElement {
	...
	@property({ type: Array })
	installedPlugins: InlangProject2["installed"]["plugins"] =
	...
	private get _settingProperties(): Record<
		...
		{
			meta?: InstalledPlugin | InstalledLintRule
...
declare global {
	interface HTMLElementTagNameMap {
		"inlang-settings2": InlangSettings2
	}
}
