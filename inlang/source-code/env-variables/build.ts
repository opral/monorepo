...
if (errors) {
	console.error(
		"❗️❗️ Some env variables are not defined or do not pass validation. If you are an external developer, please run `npm run fetchPublicEnv` to get the latest version, if you are part of the inlang team, please check your doppler setup."
	)
