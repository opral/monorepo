...
type CliStepIn<Step extends CliStep<any, any>> =
  Step extends CliStep<infer In, any> ? In : never;
type CliStepOut<Step extends CliStep<any, any>> =
  Step extends CliStep<any, infer Out> ? Out : never;

type Pair<
  Step1 extends CliStep<any, any>,
  Step2 extends CliStep<CliStepIn<Step1>, any>,
> = CliStep<CliStepIn<Step1>, CliStepOut<Step1> & CliStepOut<Step2>>;

export function pair<
  Step1 extends CliStep<any, any>,
  Step2 extends CliStep<CliStepIn<Step1>, any>,
>(step1: Step1, step2: Step2): Pair<Step1, Step2> {
