...
With v0.2 the goal of inlang takes a concreter shape: **Standardize the
internationalization/localization process of software.**
...
**Localizing software (content) involves tons of manual tasks that are doomed to be automated**: hand-offs via email,
