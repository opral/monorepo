...
const customRandom = (alphabet: string, defaultSize: number, getRandom: any) => {
...
const customAlphabet = (alphabet: string, size = 12) => customRandom(alphabet, size | 0, random);
 ...
 * implementation.
 */
export const nanoid: (size?: number) => string = customAlphabet(_nanoIdAlphabet);
