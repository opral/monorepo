 ...
 * Must be a string that starts with "custom-" followed by any characters.
 * @returns {boolean} Returns true if it is a custom strategy, false otherwise.
 */
export function isCustomStrategy(strategy) {
	return typeof strategy === "string" && /^custom-.+$/.test(strategy);
}

/**
 * Defines a custom strategy that is executed on the server.
 *
 * @param {any} strategy The name of the custom strategy to define. Must follow the pattern custom-name.
