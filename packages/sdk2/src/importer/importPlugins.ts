 ...
 */
export type PreprocessImporterBeforeImportFunction = (
	moduleText: string
...
export async function importPlugins(args: {
	...
	/** @deprecated Please find a differenet pattern for this, this sucks  */
	preprocessPluginBeforeImport?: PreprocessImporterBeforeImportFunction;
}): Promise<{
