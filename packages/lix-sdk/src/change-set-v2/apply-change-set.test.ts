...
test.todo("it applies the changes associated with the change set", async () => {
...
test.todo("throws an error if plugin does not exist", async () => {
	const lix = await openLixInMemory({});
...
test.todo(
	"throws an error if plugin does not support applying changes",
	async () => {
...
test.todo(
	"applies changes recursively from target and all ancestors",
	async () => {
