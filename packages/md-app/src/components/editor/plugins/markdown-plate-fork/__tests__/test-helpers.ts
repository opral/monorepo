...
import { deserializeMd } from '../deserializer/utils/deserializeMd';
 ...
 */
export function roundtripMarkdown(editor: PlateEditor, markdown: string): string {
  // Step 1: Deserialize markdown to editor value
  const editorValue = deserializeMd(editor, markdown);
 ...
 */
export function deserializeMarkdown(editor: PlateEditor, markdown: string): Descendant[] {
 ...
 */
export function serializeToMarkdown(editor: PlateEditor, value: Descendant[]): string {
...
export const testCases = {
  heading: '# Heading 1\n## Heading 2\n### Heading 3',
  paragraph: 'This is a paragraph with two sentences. Here is the second sentence.\n\nThis is another paragraph.',
  emphasis: '*Italic text* using asterisks.\n**Bold text** using double asterisks.\n~~Strikethrough~~ using tildes.',
  lists: '- Item 1\n- Item 2\n  - Subitem 2.1\n  - Subitem 2.2\n- Item 3\n\n1. First item\n2. Second item\n   1. Subitem 2.1\n   2. Subitem 2.2\n3. Third item',
  links: '[GitHub](https://github.com) is a popular platform for hosting code.',
  blockquotes: '> This is a blockquote. It can span multiple lines.\n>\n> - It supports lists.\n> - And other formatting.',
