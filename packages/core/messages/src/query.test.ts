...
import { MessageQueryApi, createQuery } from "./query.js"
import { it, describe, expect } from "vitest"
import type { Message, Text } from "./schema.js"

export const queryBaseTests = <QueryApi extends MessageQueryApi>(args: {
...
queryBaseTests({
	createQueryFn: (messages: Message[]) => createQuery(messages)
})
