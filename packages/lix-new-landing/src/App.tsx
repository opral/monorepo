...
const LixLogo = ({ className = "" }) => (
  <svg width="30" height="22" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <g id="Group 162">
      <path id="Vector" d="M14.7618 5.74842L16.9208 9.85984L22.3675 0.358398H25.7133L19.0723 11.6284L22.5712 17.5085H19.2407L16.9208 13.443L14.6393 17.5085H11.2705L14.7618 11.6284L11.393 5.74842H14.7618Z" fill="#2563EB"/>
      <path id="Vector_2" d="M6.16211 17.5081V5.74805H9.42368V17.5081H6.16211Z" fill="#2563EB"/>
      <path id="Vector_3" d="M3.52112 0.393555V17.6416H0.287109V0.393555H3.52112Z" fill="#2563EB"/>
      <path id="Rectangle 391" d="M6.21582 0.393555H14.8399V3.08856H6.21582V0.393555Z" fill="#2563EB"/>
    </g>
  </svg>
);
...
const PackageInstaller = ({ 
  ...
  const setPackageManager = setExternalPackageManager || setInternalPackageManager;
  ...
  return (
    <div className="flex flex-col items-center gap-4 mt-4">
      <div className="flex justify-center mb-2 border-b border-gray-200 w-48">
        <button
          className={`text-xs px-3 py-1 transition-all duration-200 border-b-2 ${packageManager === 'npm' ? 'border-gray-600 text-gray-800 font-medium' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
          onClick={() => setPackageManager('npm')}
        >
          npm
        </button>
        <button
          className={`text-xs px-3 py-1 transition-all duration-200 border-b-2 ${packageManager === 'yarn' ? 'border-gray-600 text-gray-800 font-medium' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
          onClick={() => setPackageManager('yarn')}
        >
          yarn
        </button>
        <button
          className={`text-xs px-3 py-1 transition-all duration-200 border-b-2 ${packageManager === 'pnpm' ? 'border-gray-600 text-gray-800 font-medium' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
    ...
    <div className="font-sans text-gray-900 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <main className="relative px-4 sm:px-6">
        ...
        <section className="py-28 text-center max-w-3xl mx-auto">
          <h1 className="text-gray-900 text-5xl sm:text-6xl font-bold mb-6 leading-tight">
            Embed change control<br />
            into your app
          </h1>
          
          <div className="flex items-center justify-center mb-10">
            <a href="https://www.npmjs.com/package/@lix-js/sdk" 
               target="_blank" 
              ...
              <span className="text-sm text-gray-700">27k+ monthly downloads</span>
            </a>
          </div>
          ...
          <div className="flex justify-center mt-6">
            ...
            >
              <span className="flex items-center">
                Try a demo app 
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-2 group-hover:ml-3 transition-all duration-200" fill="none" viewBox="0 0 24 24" stroke="white">
        ...
        <section className="py-20 bg-gradient-to-r from-gray-50 to-white w-full px-6 sm:px-12 md:px-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-14 max-w-[100rem] mx-auto px-4 sm:px-6">
            <div className="group cursor-pointer text-center">
                ...
                <div className="w-full h-64 lg:h-auto lg:aspect-[3/2] relative">
                  <div className="absolute inset-0 flex">
                    ...
                    <div className="w-1/2 bg-gray-50 p-4">
                      <div className="h-5 w-3/4 bg-blue-100 rounded mb-3 border border-blue-200"></div>
                      <div className="h-3 w-full bg-gray-100 rounded mb-2"></div>
                      <div className="h-3 w-5/6 bg-gray-100 rounded mb-2"></div>
                      <div className="h-3 w-11/12 bg-gray-100 rounded mb-4"></div>
                      <div className="h-4 w-2/3 bg-green-100 rounded mb-2 border border-green-200"></div>
                      <div className="h-3 w-full bg-gray-100 rounded mb-2"></div>
              ...
              <div className="mt-6">
                <p className="text-gray-800 text-xl font-medium">Document editors</p>
                <p className="text-gray-800 text-xl font-medium">with versions</p>
              </div>
            </div>
            <div className="group cursor-pointer text-center">
              <div className="bg-white rounded-xl overflow-hidden transition-all duration-300 border border-gray-200 shadow-sm">
                ...
                <div className="w-full h-64 lg:h-auto lg:aspect-[3/2] relative">
                  <div className="absolute inset-0 flex">
                    ...
                    <div className="w-1/4 bg-gray-50 p-2 border-l border-gray-200">
                      ...
                      <div className="h-3 w-1/2 bg-blue-500 rounded-sm text-white text-[8px] flex items-center justify-center">Cell History</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-6">
                <p className="text-gray-800 text-xl font-medium">Spreadsheets with</p>
                <p className="text-gray-800 text-xl font-medium">complete history</p>
              </div>
            </div>
            <div className="group cursor-pointer text-center">
              <div className="bg-white rounded-xl overflow-hidden transition-all duration-300 border border-gray-200 shadow-sm">
                    ...
                    <div className="w-3/4 bg-white p-3">
                      ...
                      {[...Array(6)].map((_, i) => (
                        <div key={i} className="h-5 w-full bg-white rounded-sm mb-1 flex border-b border-gray-100">
                          ...
                          <div className="w-1/5 border-r border-gray-100 h-full flex items-center">
                            <div className={`h-2 ${i === 2 ? "w-2/3 bg-green-300" : "w-2/3 bg-gray-300"} mx-1 rounded-sm`}></div>
                          </div>
                          <div className="w-1/5 border-r border-gray-100 h-full flex items-center">
                            <div className={`h-2 ${i === 3 ? "w-1/2 bg-blue-300" : "w-1/2 bg-gray-300"} mx-1 rounded-sm`}></div>
                          </div>
                          <div className="w-1/5 border-r border-gray-100 h-full flex items-center">
                            <div className="h-2 w-3/4 bg-gray-300 mx-1 rounded-sm"></div>
                          </div>
              ...
              <div className="mt-6">
                <p className="text-gray-800 text-xl font-medium">Agents that perform</p>
        ...
        <section className="py-24 border-t border-gray-100 max-w-4xl mx-auto">
          <h3 className="text-2xl font-semibold mb-10 text-center text-gray-800">Ready to enhance your application?</h3>
          <p className="text-gray-600 text-lg text-center max-w-xl mx-auto mb-16">
            Join developers who are building the next generation of collaborative applications with lix.
          </p>
      ...
      <footer className="max-w-3xl mx-auto px-5 py-16 text-center border-t border-gray-100 mt-10">
        <div className="flex justify-center space-x-8 mb-8">
          <a href="https://opral.io" className="text-gray-500 hover:text-gray-800 transition-colors duration-200">opral.io</a>
          <a href="/privacy" className="text-gray-500 hover:text-gray-800 transition-colors duration-200">Privacy</a>
          <a href="/terms" className="text-gray-500 hover:text-gray-800 transition-colors duration-200">Terms</a>
          <a href="/contact" className="text-gray-500 hover:text-gray-800 transition-colors duration-200">Contact</a>
        </div>
        <p className="text-gray-400 text-sm">©opral (c) 2025 • Building better collaborative software</p>
      </footer>
    </div>
  );
}
