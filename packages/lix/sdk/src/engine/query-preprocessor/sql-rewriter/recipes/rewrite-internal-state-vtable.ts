...
function buildCandidatesBody(options: { includeTransaction: boolean }): string {
	const segments: string[] = [];
	if (options.includeTransaction) {
		segments.push(buildCandidateTransactionSegment());
	}
	segments.push(
	...
	if (options.includeTransaction) {
		segments.push(buildCandidateInheritedTransactionSegment());
	}
...
function buildCandidateTransactionSegment(): string {
	return stripIndent(`
		SELECT
...
function buildCandidateUntrackedSegment(): string {
	return stripIndent(`
		SELECT
...
function buildCandidateCacheSegment(): string {
	return stripIndent(`
		SELECT
...
function buildCandidateInheritedCacheSegment(): string {
	return stripIndent(`
		SELECT
...
function buildCandidateInheritedUntrackedSegment(): string {
	return stripIndent(`
		SELECT
...
function buildCandidateInheritedTransactionSegment(): string {
	return stripIndent(`
		SELECT
