...
/**
 * Internal type that applies LixGenerated markers to properties that provide defaults.
 */
 ...
 * 2. Wraps properties that declare defaults (`default` or `x-lix-default`) in LixGenerated markers
