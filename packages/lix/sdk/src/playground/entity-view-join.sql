...
SELECT
	a."lixcol_id" AS "a_id",
	b."lixcol_id" AS "b_id",
	a."column_a" AS "a_column_a",
	b."column_b" AS "b_column_b"
FROM "test_schema" AS a
JOIN "other_schema" AS b ON
	a."lixcol_version_id" = b."lixcol_version_id"
	AND json_extract(b."column_b", '$.parent') = a."lixcol_id"
		...
		WITH RECURSIVE
			...
			"state_candidates" AS (
				SELECT
					...
					NULL AS "inherited_from_version_id",
					1 AS "priority"
				FROM "lix_internal_state_cache_v1_other_schema" AS "cache"
				JOIN "params" ON "params"."version_id" = "cache"."version_id"
				WHERE "cache"."schema_key" = 'other_schema'
