...
test("uuidV7 returns deterministic values when deterministic mode is enabled", async () => {
	...
	const id1 = await uuidV7({ lix });
	const id2 = await uuidV7({ lix });
	const id3 = await uuidV7({ lix });
...
test("uuidV7 toggles between deterministic and random", async () => {
	...
	const deterministicId = await uuidV7({ lix });
	...
	const randomId = await uuidV7({ lix });
	...
	const deterministicId2 = await uuidV7({ lix });
...
test("uuidV7 is persisted across lix instances", async () => {
	...
	const id1 = await uuidV7({ lix: lix1 });
	const id2 = await uuidV7({ lix: lix1 });
	const id3 = await uuidV7({ lix: lix1 });
	...
	const id4 = await uuidV7({ lix: lix2 });
