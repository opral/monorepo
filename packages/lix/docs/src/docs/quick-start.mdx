...
Lix is a JavaScript SDK for change control that enables Git-like capabilities for apps and agents: [Change proposals](/docs/change-proposals), [versioning](/docs/versions) (branching), [history](/docs/history), [blame](/docs/attribution), and more.
