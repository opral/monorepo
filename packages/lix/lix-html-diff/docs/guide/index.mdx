...
const beforeHtml = `
  <p data-diff-id='p1'>Old text.</p>
`;
const afterHtml = `
  <p data-diff-id='p1'>Updated text!</p>
  <p data-diff-id='p2'>Added.</p>
`;
...
<Showcase
  before="<p data-diff-id='p1'>Old text.</p>"
  after="<p data-diff-id='p1'>Updated text!</p><p data-diff-id='p2'>Added.</p>"
