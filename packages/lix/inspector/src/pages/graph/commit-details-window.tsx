...
interface CommitDetailsWindowProps {
...
export function CommitDetailsWindow({
  ...
  const changeSetElements = useQuery(({ lix }) =>
    lix.db
      ...
      .orderBy("change_set_element.schema_key")
      .orderBy("change_set_element.file_id")
      .orderBy("change_set_element.entity_id")
  );
      ...
      <div className="space-y-4">
        ...
        <div className="mb-4">
          <h4 className="text-sm font-medium mb-2">
            Change Set:{" "}
            <span className="font-mono text-xs">{commit.change_set_id}</span>
          </h4>
        </div>
