...
export default defineConfig({
  ...
  description: "Official documentation for the Lix SDK - a change control system that runs in the browser",
  head: [
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/opral/lix-sdk' }
    ],
      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Change Proposals', link: '/guide/concepts/change-proposals' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Browser Integration', link: '/guide/advanced/browser-integration' },
      ...
      '/examples/': [
        {
          ...
          items: [
            ...
            { text: 'Version Management', link: '/examples/version-management' },
