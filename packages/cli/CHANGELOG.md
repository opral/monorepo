...
- fea4e68: Require the `INLANG_GOOGLE_TRANSLATE_API_KEY` environment variable for machine translations.
...
- fea4e68: Upgraded the [inlang SDK](https://github.com/opral/inlang-sdk) to [Lix](https://lix.dev/) v0.5 🎉
