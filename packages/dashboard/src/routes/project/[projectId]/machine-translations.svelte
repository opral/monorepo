...
<p>
	Translations can be autogenerated through <Link href="https://www.deepl.com/">Deepl</Link> for increased
	productivity of translations.
</p>

<p>
	<Link
		href="https://support.deepl.com/hc/en-us/articles/360019925219-Languages-included-in-DeepL-Pro"
		>Deepl supported languages can be seen here.</Link
	>
</p>
...
<Tabs>
	...
	<div slot="content">
		...
		<TabContent>
			<Toggle
				class="mb-2"
				labelText="Machine Translations"
				labelA="Disabled"
				labelB="Enabled"
				bind:toggled
			/>
