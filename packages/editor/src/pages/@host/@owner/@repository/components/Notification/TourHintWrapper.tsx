...
const MissingLintRules = () => {
  return (
    <div class="w-full flex flex-col gap-2">
      ...
      <div class="pt-2 pb-1 px-1 flex flex-col gap-1">
        <p class="text-sm font-medium text-info-on-inverted-container">
          <span class="text-primary-on-inverted-container">Add</span> lint rules
...
const MissingTranslationRule = () => {
  return (
    <div class="w-full flex flex-col gap-2">
      ...
      <div class="pt-2 pb-1 px-1 flex flex-col gap-1">
        <p class="text-sm font-medium text-info-on-inverted-container">
          <span class="text-primary-on-inverted-container">Click</span> to see
          what’s missing
        </p>
...
const Textfield = () => {
  return (
    <div class="w-full flex flex-col gap-2">
      ...
      <div class="pt-2 pb-1 px-1 flex flex-col gap-1">
        <p class="text-sm font-medium text-info-on-inverted-container">
          <span class="text-primary-on-inverted-container">Click</span> in the
          text field
        </p>
