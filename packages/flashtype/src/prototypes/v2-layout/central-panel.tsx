 ...
 */
export function CentralPanel({ panel, onSelectView, onRemoveView, viewContext }: CentralPanelProps) {
	...
	return (
		<section ref={setNodeRef} className="flex h-full w-full flex-col text-neutral-900">
			<Panel className={isOver ? "ring-2 ring-brand-600 ring-inset" : ""}>
				...
				{hasViews ? (
					<Panel.Content>
						{activeView && activeInstance && <ViewPanel view={activeView} context={viewContext} instance={activeInstance} />}
					</Panel.Content>
				) : (
