...
const assertCorrectPluginOrder = (code: string) => {
	if (code.split('\n')[0]?.match(REGEX_SVELTE_COMPILER_INFO)) {
		throw new InlangError('Make sure to place the inlang plugin before the svelte plugin in your vite config. See https://inlang.com/documentation/sdk/sveltekit.')
	}
