    ...
    <div class="relative w-full h-full">
      <div class="bg-background w-full h-full border border-surface-300 rounded-3xl overflow-hidden">
        ...
        <div class="h-2/3 md:h-1/2 flex flex-col items-center justify-center gap-2 sm:gap-5 pt-4 sm:pt-8">
          <h3 class="text-slate-900 text-2xl xl:text-3xl font-bold">
            paraglide-next
          </h3>
          <div
            onClick={(e) => {
              ...
              showToast({
                ...
                variant: "success",
                message:
                  "You have successfully copied the command to your clipboard",
              });
            }}
          ...
          >
            <p>
              npx{" "}
              <span style={{ color: "#357fd3" }}>@inlang/paraglide-next</span>{" "}
              init
            </p>
