...
export class InputsNodeView implements NodeView {
  ...
  constructor(_node: Node, view: EditorView, getPos: () => number | undefined) {
    ...
    rowWrapper.className = 'flex flex-row items-center gap-2';
    this.dom.appendChild(rowWrapper);
    
    // Create the content container
    this.contentDOM = document.createElement('div');
    this.contentDOM.className = 'flex flex-row items-center gap-2';
    ...
    newInputBtn.className = 'btn btn-sm btn-outline';
