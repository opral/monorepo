...
var index$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  abbreviateRef: abbreviateRef,
  applyDelta: applyDelta,
  arrayRange: arrayRange,
  assertParameter: assertParameter,
  basename: basename,
  BufferCursor: BufferCursor,
  calculateBasicAuthHeader: calculateBasicAuthHeader,
  collect: collect,
  compareAge: compareAge,
  comparePath: comparePath,
  compareRefNames: compareRefNames,
  compareStats: compareStats,
  compareStrings: compareStrings,
  compareTreeEntryPath: compareTreeEntryPath,
  DeepMap: DeepMap,
  deflate: deflate,
  dirname: dirname,
  emptyPackfile: emptyPackfile,
  extractAuthFromUrl: extractAuthFromUrl,
  FIFO: FIFO,
  filterCapabilities: filterCapabilities,
  flat: flat,
  flatFileListToDirectoryStructure: flatFileListToDirectoryStructure,
  forAwait: forAwait,
  formatAuthor: formatAuthor,
  formatInfoRefs: formatInfoRefs,
  ...
  mergeFile: mergeFile,
  mergeTree: mergeTree,
  mode2type: mode2type$1,
  modified: modified,
  normalizeAuthorObject: normalizeAuthorObject,
  normalizeCommitterObject: normalizeCommitterObject,
  ...
  pkg: pkg,
  posixifyPathBuffer: posixifyPathBuffer,
  resolveBlob: resolveBlob,
  resolveCommit: resolveCommit,
  resolveFileIdInTree: resolveFileIdInTree,
  ...
  GitWalkSymbol: GitWalkSymbol,
  toHex: toHex,
  translateSSHtoHTTP: translateSSHtoHTTP,
  isPromiseLike: isPromiseLike,
  isObject: isObject,
  isFunction: isFunction,
  unionOfIterators: unionOfIterators,
  worthWalking: worthWalking
});
...
class GitIndexManager {
  ...
  static async acquire({ fs, gitdir, cache, allowUnmerged = true }, closure) {
    ...
    let result;
    let unmergedPaths = [];
    await lock$1.acquire(filepath, async () => {
