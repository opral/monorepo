	...
	return (
		<>
			<div className="grid md:grid-cols-2 justify-center md:justify-start gap-16 md:gap-8 lg:gap-24 mt-12 mb-12">
				<div className="max-w-md">
					...
					<p className="mt-8 mb-6">
						The lix change control system allows storing, tracking, querying, and reviewing changes
						in different file formats, e.g. .xlsx, .sqlite, or .inlang.
					</p>
			...
			<div className="flex flex-col items-center">
				...
				<p className="max-w-md text-center mt-2 mb-8">
					Change control can be accessed in file-based applications that are already built on Lix or
					the Lix File Manager, which can track changes of conventional files.
				</p>
			...
			<div className="flex flex-col gap-4 max-w-xl md:mx-auto pl-4 md:pl-16 border-l-2 border-surface-200">
				<p className="italic text-slate-800">
					...
					around changes. A system, that can understand changes and inform you about that these
					changes happened, means that you have a system to collaborate, validate, automate and
					create."
				</p>
				<p>
					Samuel Stroschein,{" "}
